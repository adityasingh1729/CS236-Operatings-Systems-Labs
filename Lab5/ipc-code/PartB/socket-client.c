...
int main(int argc, char *argv[])
{
    ...
    fseek(fp, 0, SEEK_END);   // fseek: used to take the pointer fp to anywhere in the file, here to the end
    int file_size = ftell(fp); // ftell gives the current position of the file pointer in the file
